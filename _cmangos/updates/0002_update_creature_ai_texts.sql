-- THANKS to dope250!
-- https://github.com/dope250/gmdb/blob/master/_mangos/creature_ai_texts.sql
...
UPDATE creature_ai_texts SET content_loc3 = '$GSchwacher:Schwache:c' WHERE entry = -356;
...
UPDATE creature_ai_texts SET content_loc3 = '$GEin lebendiger:Eine lebendige:r' WHERE entry = -161;
...
UPDATE creature_ai_texts SET content_loc3 = 'Lang leben die Orcs des Drachenmals! Sterbt, $Gwertloser:werlose:r' WHERE entry = -102;
...
UPDATE creature_ai_texts SET content_loc3 = 'Ihr tragt die Besudelung der Geißel. Macht Euch bereit, den Wirbelnden Nether zu betreten.' WHERE entry = -1306;
...
UPDATE creature_ai_texts SET content_loc3 = 'Der Tod hat mich geholt! Ich kann nicht weiter! Ich habe nichts zu verlieren...' WHERE entry = -1302;
UPDATE creature_ai_texts SET content_loc3 = 'Ich werde es nicht schaffen... geht... geht ohne mich weiter...' WHERE entry = -1301;
UPDATE creature_ai_texts SET content_loc3 = 'Wenn ich das hier überleben sollte, werde ich meine Lebensaufgabe darauf beschränken Arthas zu zerstören...' WHERE entry = -1300;
UPDATE creature_ai_texts SET content_loc3 = 'Fremder, finde den gefallenen Prinzen Menethil und beende seine Schreckensherrschaft.' WHERE entry = -1299;
UPDATE creature_ai_texts SET content_loc3 = 'Endlich, es endet...' WHERE entry = -1298;
UPDATE creature_ai_texts SET content_loc3 = 'Wir werden wieder einmal vereint sein, meine Liebe...' WHERE entry = -1297;
UPDATE creature_ai_texts SET content_loc3 = 'Die Macht des Lichts ist wahrlich großartig und barmharzig.' WHERE entry = -1296;
UPDATE creature_ai_texts SET content_loc3 = 'Törichte Sterbliche, Ihr dient mir nun!' WHERE entry = -1295;
...
UPDATE creature_ai_texts SET content_loc3 = 'Oh jetzt seid ihr zu weit gegangen und habt mich wütend gemacht! Zeit die wahre Macht des Steins von Tides zu sehen!' WHERE entry = -1226;
UPDATE creature_ai_texts SET content_loc3 = 'Zu... einfach!' WHERE entry = -1225;
UPDATE creature_ai_texts SET content_loc3 = 'Ich bin die Hand des Lich Königs!' WHERE entry = -1224;
...
UPDATE creature_ai_texts SET content_loc3 = 'Wir hungern nach Rache.' WHERE entry = -1202;
UPDATE creature_ai_texts SET content_loc3 = 'Gesäubert durch Schmerz!' WHERE entry = -1201;
UPDATE creature_ai_texts SET content_loc3 = 'Ich werde euch die Geheimnisse vom Fleisch schneiden!' WHERE entry = -1200;
UPDATE creature_ai_texts SET content_loc3 = 'Dreckige Geheimnisse!' WHERE entry = -1199;
UPDATE creature_ai_texts SET content_loc3 = 'Erzählt es mir... erzählt mir alles!' WHERE entry = -1198;
UPDATE creature_ai_texts SET content_loc3 = 'TIMMY!' WHERE entry = -1197;
UPDATE creature_ai_texts SET content_loc3 = 'Ihr wurdet gerade MALOWNED!' WHERE entry = -1196;
...
UPDATE creature_ai_texts SET content_loc3 = '%s quetscht das letzte bisschen Leben vom $n aus und schluckt dessen Seele.' WHERE entry = -1141;
UPDATE creature_ai_texts SET content_loc3 = 'Der Alptraum kann nicht gestoppt werden!' WHERE entry = -1140;
UPDATE creature_ai_texts SET content_loc3 = 'Kommt, $n. Seht was der Alptraum euch bringen wird...' WHERE entry = -1139;
UPDATE creature_ai_texts SET content_loc3 = 'Tötet $N!' WHERE entry = -1119;
UPDATE creature_ai_texts SET content_loc3 = 'Hey! Haut ab von unserem Schatz!' WHERE entry = -1057;
UPDATE creature_ai_texts SET content_loc3 = 'Das ist unser Schatz, Landstreicher!' WHERE entry = -1056;
UPDATE creature_ai_texts SET content_loc3 = 'Ihr seid in der Gegenwart eines Gottes!' WHERE entry = -1048;
UPDATE creature_ai_texts SET content_loc3 = 'Dies wird euch lehren von den Kräutern fern zu bleiben, &r.' WHERE entry = -1019;
UPDATE creature_ai_texts SET content_loc3 = 'Was? Du kannst mich nicht besiegen! Ich werde wiederkommen!' WHERE entry = -987;
UPDATE creature_ai_texts SET content_loc3 = '%s sieht ausreichend geschwächt aus um gefangen genommen zu werden.' WHERE entry = -274;
